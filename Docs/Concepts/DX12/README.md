...
### Pipeline (파이프라인 구성)
- [PipelineStateObject.md](./Pipeline/PipelineStateObject.md) - PSO 개념 ([#14](https://github.com/jiy12345/DX12GameEngine/issues/14))
...
- [ResourceBarriers.md](./Resources/ResourceBarriers.md) - 리소스 배리어와 상태 전환 ([#21](https://github.com/jiy12345/DX12GameEngine/issues/21))

> **참고**: Constant Buffer는 DX12 고유 기능이 아니라 그래픽스 보편 개념이므로:
> - 개념: [Rendering/ResourceBinding.md](../Rendering/ResourceBinding.md)
> - DX12 구현: [Usage/BasicTasks/UsingConstantBuffer.md](../../Usage/BasicTasks/UsingConstantBuffer.md)
...
**리소스 활용법 (Usage 참조)**:
- Constant Buffer 사용 → [Usage/BasicTasks/UsingConstantBuffer.md](../../Usage/BasicTasks/UsingConstantBuffer.md)
