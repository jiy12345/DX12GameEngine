...
이 상태들은 배리어(Resource Barrier)로 변경할 수 없다. [Debug Layer](../Debugging/DebugLayer.md)가 이 규칙 위반을 런타임에 즉시 감지하고 오류를 출력한다.
...
### 선행 개념
- [CommandList](../Commands/CommandList.md) - 복사 커맨드 기록
- [Synchronization](../Synchronization/Synchronization.md) - 업로드 완료 대기

### 연관 개념
- [ResourceBinding](../../Rendering/ResourceBinding.md) - 셰이더 리소스 바인딩 개념 (UPLOAD 힙의 주요 사용처)
- [UsingConstantBuffer](../../../Usage/BasicTasks/UsingConstantBuffer.md) - UPLOAD 힙의 대표적 사용 사례 (DX12 구현)
